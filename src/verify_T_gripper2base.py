...
LOG_FILE = LOG_DIR / f"verify_T_gripper2base_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
...
def main():
    ...
    try:
        for pose in data["poses"]:
            ...
            logger.info(f"Saved translation (mm): [{saved_translation[0]*1000:.2f}, {saved_translation[1]*1000:.2f}, {saved_translation[2]*1000:.2f}]")
            logger.info("")
            ...
            logger.info(f"Current translation (mm): [{current_translation[0]*1000:.2f}, {current_translation[1]*1000:.2f}, {current_translation[2]*1000:.2f}]")
            logger.info("")
            ...
            logger.info(f"  Saved:   [{saved_translation[0]*1000:.2f}, {saved_translation[1]*1000:.2f}, {saved_translation[2]*1000:.2f}] mm")
            logger.info(f"  Current: [{current_translation[0]*1000:.2f}, {current_translation[1]*1000:.2f}, {current_translation[2]*1000:.2f}] mm")
            logger.info(f"  Diff:    [{diff[0]*1000:.2f}, {diff[1]*1000:.2f}, {diff[2]*1000:.2f}] mm")
